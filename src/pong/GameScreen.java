...
public class GameScreen extends Pane {
	...
	public GameScreen(Game game) {
		...
		// "Ritar Objekt" Det som h�nder h�r �r att den ritar inte utan binder ihop
		// knutar i en annan klass
		// och sen fyller de i f�rg s� att de ser ut som platformar och boll
		// Det �r i style klassen som man f�rger dessa.
		...
		playerScore.boundsInLocalProperty().addListener(observable -> {
			 ...
			 * right away. Therefore, we listen for changes and update the position once the
